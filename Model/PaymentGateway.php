...
class PaymentGateway extends PaymentGateway_parent
{
    ...
    {
        /** @var \OxidEsales\Eshop\Application\Model\UserPayment $oUserPayment */
        ...
        if ($sUserPaymentId === $oShop->getPayPalPlusConfig()->getPayPalPlusMethodId()) {
            ...
            if ($sInvoiceNumber = $oPayPalSession->getInvoiceNumber()) {
                $oOrder->oxorder__oxordernr->value = new \OxidEsales\Eshop\Core\Field($sInvoiceNumber);
            }
     ...
     * @return bool
     */
    protected function _executePayment(\OxidEsales\Eshop\Application\Model\Order $oOrder)
    {
        $blSuccess = false;
