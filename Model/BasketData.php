...
class BasketData extends \OxidProfessionalServices\PayPalPlus\Model\PuiDataProvider
{
    ...
    {
        return array(\OxidEsales\Eshop\Application\Model\Basket::class => $this->getShop()->getBasket());
    }
    ...
    protected function _getData()
    {
        ...
        $oBasket = $this->_getSourceObject(\OxidEsales\Eshop\Application\Model\Basket::class);
