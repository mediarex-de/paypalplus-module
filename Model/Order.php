...
class Order extends Order_parent
{
    ...
    {
        $this->oxorder__oxpaid = new \OxidEsales\Eshop\Core\Field((string) $sDateAndTime);
    }
    ...
    {
        \OxidEsales\Eshop\Core\Registry::get(\OxidEsales\Eshop\Core\UtilsView::class)->addErrorToDisplay($sMessage);
    }
    ...
    public function exportStandart($oPdf)
    {
        ...
        $sOrderDate = \OxidEsales\Eshop\Core\Registry::get(\OxidEsales\Eshop\Core\UtilsDate::class)->formatDBDate($aOrderDate[0]);
