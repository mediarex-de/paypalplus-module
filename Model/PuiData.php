 ...
 */
class PuiData extends \OxidEsales\Eshop\Core\Model\BaseModel
{
    /**
    ...
    /**
     * Class constructor, calls patent constructor and initiates object
     */
    public function __construct()
    {
        parent::__construct();

        $this->init('payppaypalpluspui');
    }
    ...
    {
        $this->payppaypalpluspui__oxpaymentid = new \OxidEsales\Eshop\Core\Field($sValue);
    }
    ...
    {
        $this->payppaypalpluspui__oxreferencenumber = new \OxidEsales\Eshop\Core\Field($sValue);
    }
    ...
    {
        $this->payppaypalpluspui__oxduedate = new \OxidEsales\Eshop\Core\Field($sValue);
    }
    ...
    {
        $this->payppaypalpluspui__oxtotal = new \OxidEsales\Eshop\Core\Field((float) $fValue);
    }
    ...
    {
        $this->payppaypalpluspui__oxcurrency = new \OxidEsales\Eshop\Core\Field($sValue);
    }
    ...
    {
        $this->payppaypalpluspui__oxbankname = new \OxidEsales\Eshop\Core\Field($sValue);
    }
    ...
    {
        $this->payppaypalpluspui__oxaccountholder = new \OxidEsales\Eshop\Core\Field($sValue);
    }
    ...
    {
        $this->payppaypalpluspui__oxiban = new \OxidEsales\Eshop\Core\Field($sValue);
    }
    ...
    {
        $this->payppaypalpluspui__oxbic = new \OxidEsales\Eshop\Core\Field($sValue);
    }
    ...
    {
        $this->payppaypalpluspui__oxpuiobject = new \OxidEsales\Eshop\Core\Field($oValue->toJSON(), \OxidEsales\Eshop\Core\Field::T_RAW);
    }
    ...
    protected function _loadBy($sFieldName, $sFieldValue)
    {
        ...
        $sSelect = sprintf(
            ...
            $sFieldName,
            \OxidEsales\Eshop\Core\DatabaseProvider::getDb()->quote($sFieldValue)
        );
