 ...
 */
class PdfArticleSummaryPaymentInstructions
{
    /**
     ...
     */
    public function setOrder(\OxidEsales\Eshop\Application\Model\Order $oOrder)
    {
        $this->_oOrder = $oOrder;
    }
    ...
    protected function _translateString($sString)
    {
        ...
        $sTranslatedString = \OxidEsales\Eshop\Core\Registry::getLang()->translateString($sString, $iLang, $blAdminMode);
