 ...
 */
class OrderTab extends \OxidEsales\Eshop\Application\Controller\Admin\AdminDetailsController
{
    /**
    ...
    public function getOrder()
    {
        if (is_null($this->_oOrder)) {
            ...
            $oOrder = $this->getShop()->getNew(\OxidEsales\Eshop\Application\Model\Order::class);
